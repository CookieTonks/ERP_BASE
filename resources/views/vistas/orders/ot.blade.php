...
<body>
    <table class="table table-borderless" style="border: none;" width="100%">
        <thead>
            <tr>
                <td scope="col" style="font-size:xx-small;"><img src="logocolor.png" width="200px">
                    <p> <strong>CookieCodesS</strong> <br>
                        RFC: MBA140904LY0 <br>
                ...
                <td scope="col" style="text-align: right; font-size:xx-small;">
                    <p>Telefono: (81)8314-2767<br>
                        Correo: ventas@mymdelnorte.com / ventas@CookieCodes.com<br>
                    </p>
                    <br>
                    <br>
                    <br>
    ...
    <p style="font-size:x-small; text-align:center;">
        CookieCodes: ORDEN DE TRABAJO PARA USO INTERNO
    </p>
